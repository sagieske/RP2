...
\item[Activity extraction] Even though Twitter messages have a small size, users often try to comment as much as possible in these messages which results in short messages containing multiple activities. Also, due to the informal language, important verbs which indicate an activity are omitted.
